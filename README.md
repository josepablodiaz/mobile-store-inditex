...
Se usa **React 19** con **Vite** porque ahora mismo es lo más rápido para configurar y desarrollar. Aunque lo normal sería usar TypeScript, me he ceñido a los requisitos y está todo en **JavaScript (ES6+)**.
...
- `src/context`: Uso Context API para el carrito.
...
- **API**: Se hace la llamada GET y POST a la API tal como pedía el enunciado.
